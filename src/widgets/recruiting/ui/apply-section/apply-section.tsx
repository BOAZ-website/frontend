...
const track = [
  { track: '데이터 분석', description: '데이터 분석 소개글', icon: AnalyzeIcon },
  { track: '데이터 시각화', description: '데이터 시각화 소개글', icon: VisualizationIcon },
  { track: '데이터 엔지니어링', description: '데이터 엔지니어링 소개글', icon: EngineeringIcon },
];
const ApplySection = () => {
  return (
