  ...
  return (
    <div className={styles.container}>
      <div className={styles.unit}>
        ...
        <span className={styles.value}>{days}일</span>
      </div>
      <span className={styles.separator}>:</span>
      <div className={styles.unit}>
        <span className={styles.label}>HOUR</span>
        <span className={styles.value}>{hours}시간</span>
      </div>
      <span className={styles.separator}>:</span>
      <div className={styles.unit}>
        <span className={styles.label}>MINUTE</span>
        <span className={styles.value}>{minutes}분</span>
      </div>
      <span className={styles.separator}>:</span>
      <div className={styles.unit}>
        <span className={styles.label}>SECOND</span>
        <span className={styles.value}>{seconds}초</span>
      </div>
    </div>
  );
};
