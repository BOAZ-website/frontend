...
> = {
  분석: {
    ...
    desc: `데이터 분석은 이제 사후 확인을 넘어 실시간 예측과 대응의 영역입니다. 딥러닝 기반으로 데이터 속 패턴을 학습해\n 예측·분류·생성 모델을 직접 구현하고, 최신 인공지능 아키텍처를 실험하고 주도하며 고도의 분석 인사이트를 도출합니다.`,
    Icon: AnalyzeIcon,
  },
  시각화: {
    quote: '“데이터 속 흐름을 구조화해 실행 가능한 인사이트로 전환합니다.”',
    desc: `데이터 시각화는 단순히 데이터를 보기 좋게 표현하는 것을 넘어, 복잡한 정보를 직관적으로 전달하고\n인사이트를 빠르게 이해할 수 있도록 만드는 과정입니다. 다양한 시각화 도구와 인터랙티브 대시보드를 활용해\n데이터 스토리텔링을 구현하고, 실제 의사결정에 활용 가능한 데이터 경험을 설계합니다.`,
    Icon: VisualizationIcon,
  },
  엔지니어링: {
    quote: '“데이터를 수집하고 변환해 저장하는 흐름을 설계합니다.”',
    desc: `데이터 엔지니어링은 다양한 CS 지식과 클라우드 인프라를 바탕으로, 끊임없이 생성되고 흘러가는 데이터를\n안정적으로 수집·처리·저장하는 방법을 탐구합니다. 이를 통해 데이터가 실제로 활용될 수 있는 기반을 만들어냅니다.`,
